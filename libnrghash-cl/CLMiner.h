...
public:
    ...
    static const unsigned c_defaultGlobalWorkSizeMultiplier = 16384;
    ...
    static bool configureGPU(unsigned _localWorkSize, unsigned _globalWorkSizeMultiplier,
        unsigned _platformId, uint64_t _currentBlock, unsigned _dagLoadMode, unsigned _dagCreateDevice,
...
private:
    ...
    bool init(int height);

    std::vector<cl::Context> m_context;
